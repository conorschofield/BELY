...
from cdb.cdb_web_service.plugins.pdmLink.impl.icms import Icms
from cdb.cdb_web_service.plugins.pdmLink.objects.image import Image
from cdb.cdb_web_service.plugins.pdmLink.objects.pdmLinkComponent import PdmLinkComponent
from cdb.cdb_web_service.plugins.pdmLink.objects.pdmLinkDrawing import PdmLinkDrawing
from cdb.cdb_web_service.plugins.pdmLink.objects.pdmLinkDrawingRevision import PdmLinkDrawingRevision
from cdb.cdb_web_service.plugins.pdmLink.objects.pdmLinkSearchResult import PdmLinkSearchResult
...
class PdmLink:
    ...
    def __init__(self, username, password, windchillUrl, icmsUrl, icmsUser, icmsPass):
    ...
    def __createIcmsClient(self):
        ...
        self.icmsConnection = Icms(self.icmsUser, self.icmsPass, self.icmsUrl)
