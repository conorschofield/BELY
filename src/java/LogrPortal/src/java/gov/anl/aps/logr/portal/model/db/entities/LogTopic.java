...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "LogTopic.findAll", query = "SELECT l FROM LogTopic l"),
...
public class LogTopic extends CdbEntity implements Serializable {
    ...
    public LogTopic(Integer id) {
        this.id = id;
    }

    public LogTopic(Integer id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public String toString() {
        return "gov.anl.aps.cdb.portal.model.db.entities.LogTopic[ id=" + id + " ]";
    }
